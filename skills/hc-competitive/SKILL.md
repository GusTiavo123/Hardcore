...
- `current_solutions` — starting list of known alternatives
...
### Step 2: Profile the Strongest Competitors
...
|---|---|---|
| Market Validation Signal | Total competitors found (more = validated market) | 20 |
| Incumbent Weakness | Traction of the STRONGEST competitor (**INVERTED**: weaker = higher score) | 20 |
| Market Gap Evidence | Specific unmet needs from reviews (2+ reviewers) | 20 |
| Pricing Intelligence | Competitors with discoverable pricing | 20 |
| Failure Intelligence | Dead competitors + churn signals with identifiable causes | 20 |
...
1. State the **observable evidence**
...
**If `file`:** Write to `output/{slug}/competitive.json`
...
- Incumbent Weakness: {points}/20 (strongest competitor: {name} with {funding/reviews/employees} — {assessment})
...
Always return `["bizmodel"]` — Business Model depends on your pricing benchmark.
